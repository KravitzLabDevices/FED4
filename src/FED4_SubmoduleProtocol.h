/*
 * FED4 Submodule I2C Protocol — shared constants and pack helpers (master side).
 * Wire-format contract: examples/3_Submodules/README.md
 * Slave firmware keeps a parallel copy under examples/3_Submodules/SubmoduleProtocol.h
 * — keep both in sync when changing opcodes/status.
 */
