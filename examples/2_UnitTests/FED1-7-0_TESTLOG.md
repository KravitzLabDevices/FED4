...
| `FED4-Submodule-SeeedStudioSense.ino`      | ✓        | I2C submodule master @ 0x42, wake/status read, DS3231 SET_TIME sync, datetime JPEG capture on Seeed Sense   | Companion: `examples/3_Submodules/SeeedStudioSense/SeeedStudioSense.ino` on XIAO ESP32-S3 Sense; shared protocol in `examples/3_Submodules/`                                                                                                                                                                                                                                                  |
